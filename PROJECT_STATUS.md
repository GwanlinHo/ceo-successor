...
- [O] 2026-07-13 **M4 可玩雛形**：save(localStorage+匯出入)、UI(HUD/事件對話框/開始/說明/設定/結局)、main控制器；順手落地桿D金額縮放；單元29/29、E2E puppeteer 11/11(完整一局+存讀檔+結局)；截圖 docs/screenshots/m4-*

## 下一步
- [ ] **M5 報表中心+新聞系統**（六分頁報表含SVG趨勢圖、新聞/小道消息接 rumorTruthRate）
