...
- [O] 2026-07-13 **M5 報表+新聞**：metrics快照、六分頁報表(SVG趨勢圖)、新聞/小道消息系統(接rumorTruthRate,真新聞排真實效果)；單元34/34、E2E 14/14；截圖 m5-*

## 下一步
- [ ] **M6 美術與畫面**（sprites.js NPC/物件SVG、office.js三tier場景、各畫面視覺強化）
